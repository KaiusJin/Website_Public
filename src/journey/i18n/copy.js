export const copy = {
 en: {
  ...
  contactBody:'Have an idea, an opportunity, or a story to share? I’d love to hear from you.', end:'Every ending is a new beginning.', endBody:'Thank you for traveling with me. There are always more things to learn, build, and discover.', replay:'Back to the beginning',
 ...
 'zh-CN': {
  ...
  contactBody:'有新的想法、合作机会，或想分享的故事？欢迎给我写信。', end:'每一次抵达，都是新的出发。', endBody:'谢谢你陪我走过这段旅程。还有更多值得学习、创造和发现的事物，等待着下一次出发。', replay:'回到旅途起点',
